...
// project's I2C1 bus (DS3231 + INA226) wired to external breakout modules
...
// --- I2C ---
// Same GPIO38/GPIO39 I2C1 SDA/SCL assignment as universal_strip_controller.h
...
// GPIO40-43 to match. rtc_time_example and power_monitor_example (the only
